...
namespace LabPOO
{
    delegate bool BigSister(Product product);//igual que add product
    class Program
    {
        ...
        {
            market.Add(new Product("Leche Entera", 820, 89, "1L",1));
            market.Add(new Product("Gomitas Flipy", 720, 12, "100g",0));
            market.Add(new Product("Mantequilla", 850, 12, "125g",1));
            market.Add(new Product("Crema para hemorroides", 4990, 7, "300cc",0));
            market.Add(new Product("Pimienta", 430, 84, "15g",1));
            market.Add(new Product("Vino Sauvignon Blanc Reserva Botella", 4150, 23, "750cc",0));
            market.Add(new Product("Sal Lobos", 330, 150, "1kg",1));
            market.Add(new Product("Cuaderno Mi Pequeño Pony", 1290, 50, "1un",0));
            market.Add(new Product("Láminas de Lasaña", 1250, 85, "400g",1));
            market.Add(new Product("Tomate", 1290, 200, "1kg",0));
            market.Add(new Product("Harina", 890, 43, "1kg",1));
            market.Add(new Product("Audifonos Samsung", 5990, 40, "1un",0));
            market.Add(new Product("Pisco Alto del Carmen", 5990, 120, "1L",0));
            market.Add(new Product("Carne Molida", 4390, 15, "500g",1));
            market.Add(new Product("Aceite de Oliva", 1790, 77, "250g",1));
            market.Add(new Product("Sal parrillera", 840, 50, "750g",0));
            market.Add(new Product("Cable HDMI 1m", 3990, 25, "1un",0));
            market.Add(new Product("Queso Rallado Parmesano", 499, 102, "40g",2));
            market.Add(new Product("Vino Blanco Caja", 2790, 84, "2L",1));
            market.Add(new Product("Malla de Cebollas", 1090, 91, "1kg",1));
            market.Add(new Product("Tomates Pelados en lata", 700, 48, "540g",1));
            market.Add(new Product("Queso Parmesano", 3790, 41, "200g",0));
